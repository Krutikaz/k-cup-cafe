            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-6">
                ...
                <div className="glass-card rounded-2xl p-6 space-y-5">
                  ...
                  <a href="mailto:hello@brewandbloom.com" className="flex items-center gap-4 group">
                    <div className="w-11 h-11 rounded-xl bg-secondary/10 flex items-center justify-center group-hover:bg-secondary/20 transition-colors">
                      <Mail className="w-5 h-5 text-secondary" />
                    </div>
                    <div>
                      <p className="text-xs text-muted-foreground">Email</p>
                      <p className="text-sm font-medium group-hover:text-secondary transition-colors">hello@brewandbloom.com</p>
                    </div>
                  </a>
